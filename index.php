    ...
    <div class="row">
        <div class="col-12">
            <div class="main-box-body clearfix">
                ...
                <button type="button" id="btnOk" class="btn btn-warning btn-filter mt-2" data-box="top" data-target="ok">ok</button>
                <table class="table table-striped mt-2">
                    ...
                    <?php foreach ($result as $res){?>
                        <tr id="row-user-<?php echo $res->id; ?>">
                ...
                <button type="button" id="add_button-two" class="btn btn-primary mt-2" data-toggle="modal"  data-target="#exampleModal">add</button>
                <select class="form-select-two" aria-label="Default select example">
                    <option value="0" selected="selected">1. Please select</option>
                    <option value="1">2. Set active</option>
                    <option value="2">3. Set not active</option>
                    <option value="3">4. Delete</option>
                </select>
                <button type="button" id="btnOk-two" class="btn btn-warning btn-filter mt-2"  data-box="bottom" data-target="ok">ok</button>
            </div>
            <div class="modal fade hide" id="exampleModal" tabindex="-1" data-keyboard="false" data-backdrop="static" role="dialog" aria-labelledby="exampleModalLabel">
                <div class="modal-dialog" role="document">
                    <form id="idForm" role="form" method="POST">
                        <input name="id" id="user_id" type="hidden" value="">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title modal-title-one" id="exampleModalLabel">Modal title</h5>
                            </div>
                            <div class="modal-body">
                                <p class="modal-title modal-title-two" id="exampleModalLabel" style="display: none">'Do You Want to Delete the Record ?'</p>
                                ...
                                <div class="swichControls" style="display: none">
                                    ...
                                    <div>
                                        <select class="role-select col-md-4 mb-3" name="role" aria-label="Default select example">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" id="update" class="btn btn-primary" style="display: none">Update changes</button>
                            </div>
                        </div>
                    </form>
                </div>
